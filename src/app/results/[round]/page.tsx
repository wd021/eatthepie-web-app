...
const GameDetailsComponent = () => {
  ...
  const renderWinnersTable = (title, winners) => {
    return (
      <div className='bg-white shadow-md rounded-lg overflow-hidden mt-8'>
        <h3 className='text-xl font-semibold p-4 bg-gray-100'>{title} Winners</h3>
          ...
          <table className='min-w-full'>
            ...
            <tbody className='bg-white divide-y divide-gray-200'>
              {winners.map((winner, index) => (
                <tr key={index}>
                  <td className='px-6 py-4 whitespace-nowrap'>{winner.address}</td>
                  <td className='px-6 py-4 whitespace-nowrap'>{winner.prize}</td>
  ...
  return (
    <div className='container mx-auto px-4 py-8'>
      <h2 className='text-4xl font-bold text-center p-4'>Round #{gameData.id}</h2>
        ...
        <div className='p-6'>
          <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
            ...
            <div>
              ...
              <p className='text-xl font-semibold'>{formatDate(gameData.drawDate)}</p>
            </div>
          </div>
        </div>
      </div>
