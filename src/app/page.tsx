      ...
      <div className='flex flex-col items-center justify-center border-b border-gray-300'>
        ...
        >
          ...
          >
            ...
            <img src='/jackpot_green.png' className='shrink-0 w-full h-full' alt='Jackpot' />
        ...
        <div className='max-w-2xl mx-auto px-4'>
          ...
          <div className='space-y-6'>
            <Section icon='🌎' title='A Trustless and Fair World Lottery'>
              <div>
                Imagine a global lottery where everyone plays on equal footing, free from
                manipulation or unfair advantages. Thanks to the power of{' '}
                <a
                ...
                , we now have that: a decentralized, self-executing lottery that operates
                autonomously forever. No hidden tricks, no human involvement—just pure,
                verifiable randomness.
              </div>
              <div className='pt-4'>
                Traditional lotteries take up to <b>50% in fees</b>, leaving a fraction of the
                pool for the winners. Our lottery takes only <b>1% in fees</b>, capped at 100
                ETH. That means more of the prize money goes back to where it belongs—into the
                hands of the participants. It&apos;s a global game, accessible to anyone with an{' '}
                <a
            ...
            <Section icon='🔒' title='Unbreakable: Ethereum & VDFs'>
              <div>
                ...
                thousands of validators around the world. This robust infrastructure not only
                secures cryptocurrencies but also serves as the foundation for our lottery’s
                integrity.
              </div>
              <div className='pt-4'>
                We took it a step further by incorporating Verifiable Delay Functions (VDFs)
                into the process of generating random lottery numbers. VDFs introduce a required
                time delay, ensuring that even if validators tried to collude, they wouldn’t be
                able to predict or manipulate the outcome.
              </div>
              <div className='pt-4'>
