              ...
              <div className='space-y-4'>
                ...
                <div className='bg-gray-50 rounded-lg p-4'>
                  <ul className='list-none space-y-3'>
                    <li className='flex items-start space-x-2'>
                      ...
                      <span>
                        EatThePie is a fully decentralized lottery that operates autonomously on
                        the Ethereum blockchain.
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <span className='text-blue-500 mt-0.5'>•</span>
                      <span>The platform operates without any central authority.</span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <span className='text-blue-500 mt-0.5'>•</span>
                      <span>
                        All smart contract code is open source and publicly verifiable.
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <span className='text-blue-500 mt-0.5'>•</span>
                      <span>
                        Participating in this lottery involves risk, and you take full
                        responsibility with your actions.
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <span className='text-blue-500 mt-0.5'>•</span>
                      <span>
                        Transactions cannot be reversed or refunded as all operations are
                        controlled by immutable smart contracts.
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <span className='text-blue-500 mt-0.5'>•</span>
                    ...
                    <li className='flex items-start space-x-2'>
                      <span className='text-blue-500 mt-0.5'>•</span>
                      <span>
                        By participating, users acknowledge that they understand the risks
                        involved in interacting with blockchain technology and smart contracts.
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className='p-4 bg-yellow-50 rounded-lg border border-yellow-100'>
                  <p className='font-medium text-gray-900'>
                    Remember to always practice responsible gaming and never spend more than you
                    can afford to lose.
                  </p>
                </div>
              </div>
